(use-trait sft-trait .sip013-sft-trait.sip013-semi-fungible-token-trait)
(use-trait transfer-many-trait .sip013-transfer-many-trait.sip013-transfer-many-trait)
...
(define-public (transfer-many (transfers (list 200
    {
    token-id: uint,
    amount: uint,
    sender: principal,
...
(define-public (transfer-many-memo (transfers (list 200
    {
    token-id: uint,
    amount: uint,
    sender: principal,
...
(define-private (tag-nft-token-id (nft-token-id {
    ...
    (begin
        (and
            ...
            (try! (nft-burn? semi-fungible-token-id nft-token-id
                (get owner nft-token-id)
            ))
        )
